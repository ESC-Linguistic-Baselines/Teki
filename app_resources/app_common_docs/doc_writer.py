...
def oral ():
    ...
    with open ("../app_common_databases/oral_french.json", mode="w", encoding="utf-8") as oral_file:
...
def lit ():
    ...
    with open("../app_common_databases/lit_french.json", mode="w", encoding="utf-8") as oral_file:
        data = {
